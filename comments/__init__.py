...
class Client:
	...
	def createPost(self, owner_id=None, type='text', text=None, photo_url=None, caption=None, parse_mode=None, administrators=None, disable_notifications=None):
		...
		if type.lower() == 'text':
			...
			dic = dict(api_key=self.api_key, owner_id=owner_id, type=type, photo_url=photo_url, caption=caption, parse_mode=parse_mode, disable_notifications=disable_notifications)
	...
	def editPost(self, post_id, text=None, photo_url=None, caption=None, parse_mode=None):
		dic = dict(api_key=self.api_key, post_id=post_id, text=text, photo_url=photo_url, caption=caption, parse_mode=parse_mode)
